...
function UpFacture(Request $request){
    ...
    $facture->total_qte_1 = $request->input('price_qte_1') * $request->input('qte_1');
    ...
    $facture->total_qte_2 = $request->input('price_qte_2') * $request->input('qte_2');
    ...
    $facture->total_qte_3 = $request->input('price_qte_3') * $request->input('qte_3');
    ...
    $facture->total_qte_4 = $request->input('price_qte_4') * $request->input('qte_4');
    ...
    $facture->total_qte_5 = $request->input('price_qte_5') * $request->input('qte_5');
    ...
    $facture->total_qte_6 = $request->input('price_qte_6') * $request->input('qte_6');
    ...
    $facture->total_qte_7 = $request->input('price_qte_7') * $request->input('qte_7');
    ...
    $facture->total_qte_8 = $request->input('price_qte_8') * $request->input('qte_8');
    ...
    $facture->total_qte_9 = $request->input('price_qte_9') * $request->input('qte_9');
